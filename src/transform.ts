...
export const transform = {
    ...
    QualifiedTypeIdentifier: {
        exit(path, state) {
            ...
            const replacement = reactTypes.QualifiedTypeIdentifier.exit(
                path,
                state
            );
            if (replacement) {
        ...
        exit(path, state) {
            ...
            if (
                ...
                replacementNode = t.tsTypeAliasDeclaration(
                    ...
                    undefined,
                    t.tsTypeQuery(
                        t.tsImportType(source, t.identifier("default"))
                    )
                );
                replacementNode.leadingComments = leadingComments;
                replacementNode.trailingComments = trailingComments;
