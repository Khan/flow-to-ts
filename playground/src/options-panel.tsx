...
class OptionsPanel extends React.Component<Props> {
    ...
    render() {
        ...
        return <div style={optionsPanel}>
            <div style={{marginTop: 8, fontWeight: 700}}>Output Options</div>
            <form style={{display: "grid", gridTemplateColumns: "auto minmax(0, 1fr)", gridColumnGap: 16, gridRowGap: 4}}>
                ...
                <label htmlFor="semicolons" style={{paddingLeft: 16}}>semicolons:</label>
                <input 
                    id="semicolons"
                    type="checkbox"
                ...
                />
                <label htmlFor="single-quotes" style={{paddingLeft: 16}}>single quotes:</label>
                <input 
                    id="single-quotes"
                    type="checkbox" 
                ...
                />
                <label htmlFor="bracket-spacing" style={{paddingLeft: 16}}>bracket spacing:</label>
                <input 
                    id="bracket-spacing"
                    type="checkbox"
                ...
                />
                <label htmlFor="tab-width" style={{paddingLeft: 16}}>tab width:</label>
                <select 
                    id="tab-width"
                ...
                <label htmlFor="arrow-parens" style={{paddingLeft: 16}}>arrow parens:</label>
                <select 
                    id="arrow-parens"
                ...
                <label htmlFor="trailing-commas" style={{paddingLeft: 16}}>trailing commas:</label>
                <select 
                    id="trailing-commas"
                ...
                <label htmlFor="print-width" style={{paddingLeft: 16}}>print width:</label>
                <input 
                    id="print-width" 
                    type="text" 
